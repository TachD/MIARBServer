...
public class MacroHash {
    private static String asciiToHex(String asciiValue) {
        ...
        for (char tempChar: asciiValue.toCharArray())
            hex.append(Integer.toHexString((int) tempChar));

        return hex.toString();
    }

    private static ArrayList<String> hexToAscii(String hexValue) {
    ...
    private static int getHashSumm(String data) {
        int summ = 0;
    ...
    private static String getMacroSumm(String source) {
