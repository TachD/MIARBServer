...
/**
 * Cache' Java Class Generated for class model.Admittance on version Cache for Windows (x86-64) 2017.1.1 (Build 111U_SU) Tue May 23 2017 13:20:26 EDT.<br>
 *
 * @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance</A>
**/

public class Admittance extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 2205;
    private static String CACHE_CLASS_NAME = "model.Admittance";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>model.Admittance.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "model.Admittance" in Cache
    ...
    * objects must be instances of <code>model.Admittance</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>model.Admittance</code> or of
      any of its subclasses. Cast to <code>model.Admittance</code> is
    ...
    * to open all instances of class model.Admittance
    ...
    */
    ...
    /**
       Returns class name of the class model.Admittance as it is in
   ...
   */
    ...
    public static void checkAdmittanceTitleValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>AdmittanceTitle</code>.
       <Description>
       @return current value of <code>AdmittanceTitle</code> represented as
       <code>java.lang.String</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#AdmittanceTitle"> AdmittanceTitle</A>
    */
    public java.lang.String getAdmittanceTitle()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("AdmittanceTitle",false);
       return dh.getString();
    }

    /**
       Sets new value for <code>AdmittanceTitle</code>.
       <Description>
       ...
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#AdmittanceTitle"> AdmittanceTitle</A>
    */
    public void setAdmittanceTitle(java.lang.String value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("AdmittanceTitle", dh);
        return;
    }

    public static void checkDateEndingValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>DateEnding</code>.
       <Description>
       @return current value of <code>DateEnding</code> represented as
       <code>java.sql.Date</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateEnding"> DateEnding</A>
    */
    public java.sql.Date getDateEnding()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("DateEnding",false);
       return dh.getDate();
    }

    /**
       Sets new value for <code>DateEnding</code>.
       <Description>
       @param value new value to be set represented as
       <code>java.sql.Date</code>.
       @throws com.intersys.objects.CacheException if any error occurred during value setting.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateEnding"> DateEnding</A>
    */
    public void setDateEnding(java.sql.Date value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("DateEnding", dh);
        return;
    }

    public static void checkDateGettingValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>DateGetting</code>.
       <Description>
       @return current value of <code>DateGetting</code> represented as
       <code>java.sql.Date</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateGetting"> DateGetting</A>
    */
    public java.sql.Date getDateGetting()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("DateGetting",false);
       return dh.getDate();
    }

    /**
       Sets new value for <code>DateGetting</code>.
       <Description>
       @param value new value to be set represented as
       <code>java.sql.Date</code>.
       @throws com.intersys.objects.CacheException if any error occurred during value setting.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateGetting"> DateGetting</A>
    */
    public void setDateGetting(java.sql.Date value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("DateGetting", dh);
        return;
    }
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDEmployee"> IDEmployee</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%IsA"> Method %IsA</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%KillExtent"> Method %KillExtent</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method AdmittanceTitleDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#AdmittanceTitleDisplayToLogical"> Method AdmittanceTitleDisplayToLogical</A>
    */
    public static java.lang.String AdmittanceTitleDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"AdmittanceTitleDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method AdmittanceTitleIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#AdmittanceTitleIsValid"> Method AdmittanceTitleIsValid</A>
    */
    public static void AdmittanceTitleIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"AdmittanceTitleIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method AdmittanceTitleLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#AdmittanceTitleLogicalToDisplay"> Method AdmittanceTitleLogicalToDisplay</A>
    */
    public static java.lang.String AdmittanceTitleLogicalToDisplay (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"AdmittanceTitleLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method DateEndingDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateEndingDisplayToLogical"> Method DateEndingDisplayToLogical</A>
    */
    public static java.sql.Date DateEndingDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateEndingDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getDate();
    }
    /**
     <p>Runs method DateEndingIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateEndingIsValid"> Method DateEndingIsValid</A>
    */
    public static void DateEndingIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateEndingIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method DateEndingLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.sql.Date
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateEndingLogicalToDisplay"> Method DateEndingLogicalToDisplay</A>
    */
    public static java.lang.String DateEndingLogicalToDisplay (com.intersys.objects.Database db, java.sql.Date _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateEndingLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method DateGettingDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateGettingDisplayToLogical"> Method DateGettingDisplayToLogical</A>
    */
    public static java.sql.Date DateGettingDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateGettingDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getDate();
    }
    /**
     <p>Runs method DateGettingIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateGettingIsValid"> Method DateGettingIsValid</A>
    */
    public static void DateGettingIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateGettingIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method DateGettingLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.sql.Date
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#DateGettingLogicalToDisplay"> Method DateGettingLogicalToDisplay</A>
    */
    public static java.lang.String DateGettingLogicalToDisplay (com.intersys.objects.Database db, java.sql.Date _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"DateGettingLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDEmployeeGetObject"> Method IDEmployeeGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDEmployeeGetObjectId"> Method IDEmployeeGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDEmployeeIsValid"> Method IDEmployeeIsValid</A>
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Admittance IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Admittance IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Admittance#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Admittance IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "model.Admittance_Extent", 0, 0);
    }

    public static Object addToBatchInsert (Object batch, java.sql.Connection con, String cos_AdmittanceTitle, java.sql.Date cos_DateEnding, java.sql.Date cos_DateGetting) throws java.sql.SQLException {
        if (batch == null) {
        ...
        com.intersys.jdbc.SysListProxy.setString(qbatch.list, cos_AdmittanceTitle);
        com.intersys.jdbc.SysListProxy.setSQLDate(qbatch.list, cos_DateEnding);
        com.intersys.jdbc.SysListProxy.setSQLDate(qbatch.list, cos_DateGetting);
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("model", "Admittance", 4, batch, con, nolock);
