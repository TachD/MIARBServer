...
/**
 * Cache' Java Class Generated for class model.Contract on version Cache for Windows (x86-64) 2017.1.1 (Build 111U_SU) Tue May 23 2017 13:20:26 EDT.<br>
 *
 * @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract</A>
**/

public class Contract extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 5651;
    private static String CACHE_CLASS_NAME = "model.Contract";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>model.Contract.open</code> instead!</br></p>
           <p>
    ...
    */
    public Contract (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public Contract (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "model.Contract" in Cache
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public Contract (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>model.Contract</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>model.Contract</code> or of
      any of its subclasses. Cast to <code>model.Contract</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #Contract(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class model.Contract
    ...
    */
    ...
    /**
       Returns class name of the class model.Contract as it is in
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Contract.class);
    }
    ...
    /**
       ...
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#EndDate"> EndDate</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDEmployee"> IDEmployee</A>
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderDate"> OrderDate</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderName"> OrderName</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%IsA"> Method %IsA</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%KillExtent"> Method %KillExtent</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#EndDateDisplayToLogical"> Method EndDateDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#EndDateIsValid"> Method EndDateIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#EndDateLogicalToDisplay"> Method EndDateLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDEmployeeGetObject"> Method IDEmployeeGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDEmployeeGetObjectId"> Method IDEmployeeGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDEmployeeIsValid"> Method IDEmployeeIsValid</A>
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Contract IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Contract IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Contract IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderDateDisplayToLogical"> Method OrderDateDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderDateIsValid"> Method OrderDateIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.sql.Date
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderDateLogicalToDisplay"> Method OrderDateLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderNameDisplayToLogical"> Method OrderNameDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderNameIsValid"> Method OrderNameIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Contract#OrderNameLogicalToDisplay"> Method OrderNameLogicalToDisplay</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "model.Contract_Extent", 0, 0);
    }

    public static Object addToBatchInsert (Object batch, java.sql.Connection con, java.sql.Date cos_EndDate, java.sql.Date cos_OrderDate, String cos_OrderName) throws java.sql.SQLException {
        if (batch == null) {
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("model", "Contract", 4, batch, con, nolock);
