...
/**
 * Cache' Java Class Generated for class model.Appraisal on version Cache for Windows (x86-64) 2017.1.1 (Build 111U_SU) Tue May 23 2017 13:20:26 EDT.<br>
 *
 * @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal</A>
**/

public class Appraisal extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 7844;
    private static String CACHE_CLASS_NAME = "model.Appraisal";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>model.Appraisal.open</code> instead!</br></p>
           <p>
    ...
    */
    public Appraisal (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public Appraisal (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "model.Appraisal" in Cache
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public Appraisal (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>model.Appraisal</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>model.Appraisal</code> or of
      any of its subclasses. Cast to <code>model.Appraisal</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #Appraisal(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class model.Appraisal
    ...
    */
    ...
    /**
       Returns class name of the class model.Appraisal as it is in
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Appraisal.class);
    }
    ...
    /**
       ...
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDEmployee"> IDEmployee</A>
    */
    ...
    public static void checkNextPerformanceAppraisalDateValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>NextPerformanceAppraisalDate</code>.
       <Description>
       @return current value of <code>NextPerformanceAppraisalDate</code> represented as
       <code>java.lang.String</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#NextPerformanceAppraisalDate"> NextPerformanceAppraisalDate</A>
    */
    public java.lang.String getNextPerformanceAppraisalDate()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("NextPerformanceAppraisalDate",false);
       return dh.getString();
    }

    /**
       Sets new value for <code>NextPerformanceAppraisalDate</code>.
       <Description>
       ...
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#NextPerformanceAppraisalDate"> NextPerformanceAppraisalDate</A>
    */
    public void setNextPerformanceAppraisalDate(java.lang.String value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("NextPerformanceAppraisalDate", dh);
        return;
    }

    public static void checkPerformanceAppraisalDateValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>PerformanceAppraisalDate</code>.
       <Description>
       @return current value of <code>PerformanceAppraisalDate</code> represented as
       <code>java.sql.Date</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalDate"> PerformanceAppraisalDate</A>
    */
    public java.sql.Date getPerformanceAppraisalDate()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("PerformanceAppraisalDate",false);
       return dh.getDate();
    }

    /**
       Sets new value for <code>PerformanceAppraisalDate</code>.
       <Description>
       @param value new value to be set represented as
       <code>java.sql.Date</code>.
       @throws com.intersys.objects.CacheException if any error occurred during value setting.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalDate"> PerformanceAppraisalDate</A>
    */
    public void setPerformanceAppraisalDate(java.sql.Date value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("PerformanceAppraisalDate", dh);
        return;
    }

    public static void checkPerformanceAppraisalResultValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    }
    /**
       Returns value of property <code>PerformanceAppraisalResult</code>.
       <Description>
       @return current value of <code>PerformanceAppraisalResult</code> represented as
       <code>java.lang.String</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalResult"> PerformanceAppraisalResult</A>
    */
    public java.lang.String getPerformanceAppraisalResult()  throws com.intersys.objects.CacheException {
       com.intersys.cache.Dataholder dh = mInternal.getProperty("PerformanceAppraisalResult",false);
       return dh.getString();
    }

    /**
       Sets new value for <code>PerformanceAppraisalResult</code>.
       <Description>
       @param value new value to be set represented as
       <code>java.lang.String</code>.
       @throws com.intersys.objects.CacheException if any error occurred during value setting.
       @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalResult"> PerformanceAppraisalResult</A>
    */
    public void setPerformanceAppraisalResult(java.lang.String value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty("PerformanceAppraisalResult", dh);
        return;
    }
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%IsA"> Method %IsA</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%KillExtent"> Method %KillExtent</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDEmployeeGetObject"> Method IDEmployeeGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDEmployeeGetObjectId"> Method IDEmployeeGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDEmployeeIsValid"> Method IDEmployeeIsValid</A>
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Appraisal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Appraisal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static model.Appraisal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     <p>Runs method NextPerformanceAppraisalDateDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#NextPerformanceAppraisalDateDisplayToLogical"> Method NextPerformanceAppraisalDateDisplayToLogical</A>
    */
    public static java.lang.String NextPerformanceAppraisalDateDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"NextPerformanceAppraisalDateDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method NextPerformanceAppraisalDateIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#NextPerformanceAppraisalDateIsValid"> Method NextPerformanceAppraisalDateIsValid</A>
    */
    public static void NextPerformanceAppraisalDateIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"NextPerformanceAppraisalDateIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method NextPerformanceAppraisalDateLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#NextPerformanceAppraisalDateLogicalToDisplay"> Method NextPerformanceAppraisalDateLogicalToDisplay</A>
    */
    public static java.lang.String NextPerformanceAppraisalDateLogicalToDisplay (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"NextPerformanceAppraisalDateLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method PerformanceAppraisalDateDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalDateDisplayToLogical"> Method PerformanceAppraisalDateDisplayToLogical</A>
    */
    public static java.sql.Date PerformanceAppraisalDateDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalDateDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getDate();
    }
    /**
     <p>Runs method PerformanceAppraisalDateIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalDateIsValid"> Method PerformanceAppraisalDateIsValid</A>
    */
    public static void PerformanceAppraisalDateIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalDateIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method PerformanceAppraisalDateLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.sql.Date
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalDateLogicalToDisplay"> Method PerformanceAppraisalDateLogicalToDisplay</A>
    */
    public static java.lang.String PerformanceAppraisalDateLogicalToDisplay (com.intersys.objects.Database db, java.sql.Date _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalDateLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method PerformanceAppraisalResultDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalResultDisplayToLogical"> Method PerformanceAppraisalResultDisplayToLogical</A>
    */
    public static java.lang.String PerformanceAppraisalResultDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalResultDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method PerformanceAppraisalResultIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalResultIsValid"> Method PerformanceAppraisalResultIsValid</A>
    */
    public static void PerformanceAppraisalResultIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalResultIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method PerformanceAppraisalResultLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://DESKTOP-34GG5QJ:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=WSPACE&CLASSNAME=model.Appraisal#PerformanceAppraisalResultLogicalToDisplay"> Method PerformanceAppraisalResultLogicalToDisplay</A>
    */
    public static java.lang.String PerformanceAppraisalResultLogicalToDisplay (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PerformanceAppraisalResultLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "model.Appraisal_Extent", 0, 0);
    }

    public static Object addToBatchInsert (Object batch, java.sql.Connection con, String cos_NextPerformanceAppraisalDate, java.sql.Date cos_PerformanceAppraisalDate, String cos_PerformanceAppraisalResult) throws java.sql.SQLException {
        if (batch == null) {
        ...
        com.intersys.jdbc.SysListProxy.setString(qbatch.list, cos_NextPerformanceAppraisalDate);
        com.intersys.jdbc.SysListProxy.setSQLDate(qbatch.list, cos_PerformanceAppraisalDate);
        com.intersys.jdbc.SysListProxy.setString(qbatch.list, cos_PerformanceAppraisalResult);
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("model", "Appraisal", 4, batch, con, nolock);
